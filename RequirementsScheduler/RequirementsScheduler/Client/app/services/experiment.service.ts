...
import { Experiment, ExperimentStatus, Test, Report, Result } from '../models/index';
...
export class ExperimentService {
    ...
    getResultInfo(id: string) : Observable<Result> {
        return this.http.get<Result>(`/api/experiments/${id}/resultinfo`);
    }
