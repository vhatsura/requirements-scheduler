...
module.exports = (env) => {
    ...
    const clientBundleConfig = merge(sharedConfig, {
        ...
        plugins: [
            ...
            new AngularCompilerPlugin({
              mainPath: path.join(__dirname, 'Client/boot.browser.ts'),
    ...
    const serverBundleConfig = merge(sharedConfig, {
        ...
        entry: {
          'main-server':
          isDevBuild ? './Client/boot.server.ts' : './Client/boot.server.PRODUCTION.ts'
        },
        plugins: [
            new webpack.DllReferencePlugin({
                context: __dirname,
            ...
            // Plugins that apply in production builds only
            new AngularCompilerPlugin({
              mainPath: path.join(__dirname, 'Client/boot.server.PRODUCTION.ts'),
              tsConfigPath: './tsconfig.json',
